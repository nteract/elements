...
// Type definitions for kernel communication functions
type SendUpdate = (
  commId: string,
...
describe("CommBridgeManager", () => {
  ...
  let sendCustom: SendCustom;
  let closeComm: CloseComm;

  beforeEach(() => {
    mockStore = createMockStore();
    mockFrame = createMockFrame();
    sendUpdate = vi.fn<SendUpdate>();
    sendCustom = vi.fn<SendCustom>();
    closeComm = vi.fn<CloseComm>();
    vi.clearAllMocks();
  });

...
import { createCanvasManagerRouter } from "@/registry/widgets/canvas-manager-subscriptions";
import { createLinkManager } from "@/registry/widgets/link-subscriptions";
import {
  resolveModelRef,
  type WidgetModel,
  type WidgetStore,
...
export function IframeWidgetStoreProvider({
  ...
  // Pass sendUpdate so linked values sync back to the kernel via the parent
  useEffect(

...
import { WidgetOutputDemo, WidgetOutputInteractiveDemo } from '@/app/components/WidgetOutputDemo';
...
<Callout type="warn">
  The `@jupyter-widgets/html-manager` package uses webpack-specific globals. It works with webpack-based bundlers but may require configuration with Vite, Turbopack, or other bundlers.
</Callout>

...
<div className="my-8 rounded-xl border bg-fd-card p-6">
  <MarkdownPreview content={`# Hello from Markdown
...
<div className="my-4 rounded-lg border bg-fd-secondary/30 p-4">
  <MarkdownPreview content={`The quadratic formula: $x = \\frac{-b \\pm \\sqrt{b^2-4ac}}{2a}$
...
<div className="my-4 rounded-lg border bg-fd-secondary/30 p-4">
  <MarkdownPreview content={`| Name | Type | Description |
| --- | --- | --- |
...
<div className="my-4 rounded-lg border bg-fd-secondary/30 p-4">
  <MarkdownPreview content={`Use the \`DataFrame.describe()\` method to get statistical summaries. Import with \`import pandas as pd\`.`} />
</div>

#### Tables in Dark Mode

<div className="my-4 rounded-lg border bg-fd-secondary/30 p-4">
  <MarkdownPreview content={`| Method | Description |
| --- | --- |
| \`head()\` | First n rows |
| \`tail()\` | Last n rows |

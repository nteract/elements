...
import { CellControlsDemo } from '@/app/_components/CellControlsDemo';

<div className="my-8">
  <CellControlsDemo showMoveControls hasOutputs />
</div>
...
The controls are hidden on mobile and shown on hover for desktop.
...
<div className="my-4">
  <CellControlsDemo showMoveControls />
</div>
...
<div className="my-4">
  <CellControlsDemo contextSelectionMode />
</div>

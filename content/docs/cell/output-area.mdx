...
<div className="my-4 rounded border p-4" data-testid="widget-output-demo">
  <OutputAreaDemo variant="widget" />
</div>
...
<div className="my-4 rounded border p-4" data-testid="output-widget-demo">
  <OutputAreaDemo variant="output-widget" />
</div>

...
import { CellTypeButton, CodeCellButton, MarkdownCellButton, SqlCellButton, AiCellButton } from '@/registry/cell/CellTypeButton';
...
<Tabs items={['CLI', 'Manual']}>
  ...
  <Tab value="Manual">
    Copy from the [nteract/elements registry](https://github.com/nteract/elements/tree/main/registry/cell/CellTypeButton.tsx).
